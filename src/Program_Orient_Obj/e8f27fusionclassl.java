...
class Fusion {
    ...
    public Personaje fusionar(Personaje personaje1, Personaje personaje2) {
        return new Personaje(personaje1.fuerza + personaje2.fuerza, personaje1.velocidad + personaje2.velocidad);
    }
}
public class e8f27fusionclassl {
